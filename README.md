...
整理各种 AI Coding Plan 套餐订阅信息，方便个人开发者按模型、价格、额度和实际体验做选择。

> 信息整理时间：2026-05。套餐价格、模型列表、限购状态和计费规则变化很快，购买前请以平台官网为准。

## 选型原则

- 高频日常开发：优先选 Coding Plan。通常按请求次数计费，Token 不单独封顶，适合长对话、代码库分析、Agent 编程。
- 低频零散使用：优先走 API 按量付费，或使用免费额度，不建议购买订阅版 Token Plan, 或者看中转站. 可以去 [hvoy.ai](https://hvoy.ai)上找合适的中转站

- 需要顶级代码质量：看GPT系列, 和 Claude系列
- 预算敏感(会翻墙)：GPT系列, 不二之选. 同等价格最强plan
- 预算敏感(不翻墙)：阿里云百炼和GLM
